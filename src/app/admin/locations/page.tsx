...
export default async function LocationsPage({
  ...
  if (active) filters.push(eq(locations.active, active === "yes"));
            ...
            <tbody>
              {rows.map(({ location: l, parentName }) => (
                <tr key={l.id} className="hover:bg-slate-50/70">
                  ...
                  <Td>
                    <StatusBadge status={l.active ? "ACTIVE" : "DEACTIVATED"} />
                  </Td>
                  <Td>
                    {canManage ? (
                      <ActionButton
                        ...
                        payload={{ isActive: !l.active }}
                        tone={l.active ? "neutral" : "success"}
                        label={
                          l.active
                            ? lang === "bn"
                              ? "নিষ্ক্রিয়"
